...
class PaginationError(Exception):
    ...
    def __init__(self, message: str, last_cursor: Optional[str] = None) -> None:
...
class OktaPaginator:
        ...
        **kwargs: Any,
        ...
        while True:
            ...
            try:
                ...
                response = await self._execute_fetch(fetch_func, *args, **request_kwargs)
    ...
    def _extract_next_cursor(self, response: Any) -> Optional[str]:
